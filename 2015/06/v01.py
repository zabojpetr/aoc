...
def set_lights(arr: np.array, settings: Settings):
    if settings.mode == "toggle":
        arr[settings.x1:settings.x2, settings.y1:settings.y2] = arr[settings.x1:settings.x2, settings.y1:settings.y2] ^ True
    elif settings.mode == "on":
        arr[settings.x1:settings.x2, settings.y1:settings.y2] = True
    elif settings.mode == "off":
        arr[settings.x1:settings.x2, settings.y1:settings.y2] = False
