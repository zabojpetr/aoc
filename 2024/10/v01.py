...
def find_end_points(start_point: typing.Tuple[int, int], mapa: typing.List[typing.List[int]]) -> typing.Set[typing.Tuple[int,int]]:
    directions = [
        (1,0),
        (0,1),
        (-1,0),
    ...
    if mapa[start_point[0]][start_point[1]] == 9:
        ...
        for d in directions:
            ...
            if mapa[start_point[0]][start_point[1]] + 1 == mapa[new_possition[0]][new_possition[1]]:
                end_positions.update(find_end_points(new_possition, mapa))
